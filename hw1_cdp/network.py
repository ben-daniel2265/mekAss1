...
class NeuralNetwork(object):
    ...
    def __init__(self, sizes=list(), learning_rate=1.0, mini_batch_size=16,
        ...
        # Input layer is layer 0, followed by hidden layers 1, 2, 3...
        self.matmul = matmul
        self.sizes = sizes
...
def train_nn(sizes, learning_rate, mini_batch_size, epochs, matmul, training_data, validation_data):
    """
         Parameters
         ----------
         sizes : list of sizes
         ...
         mini_batch_size : int
         epochs : int
         matmul : matrix multiplication function
         training_data : tuple of np.ndarray of input data and np.ndarray of input labels
         validation_data : tuple of np.ndarray of input data and np.ndarray of input labels
    ...
    nn = NeuralNetwork(sizes=sizes, learning_rate=learning_rate, mini_batch_size=mini_batch_size, epochs=epochs,
                       matmul=matmul)
